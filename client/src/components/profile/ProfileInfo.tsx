    ...
    <div className="space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div>
              ...
              />
              <p className="mt-1 text-xs text-[#94A3B8]">Email không thể thay đổi</p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="bg-[#FFFFFF] rounded-lg shadow-sm p-6">
          ...
          <button className="w-full mt-6 text-[#F97316] text-sm font-medium hover:text-[#EA580C] flex items-center justify-center gap-1">
      ...
      <div className="bg-[#FEF9C3] border border-[#FACC15] rounded-lg p-4 flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <button className="text-sm text-[#F97316] font-medium hover:text-[#EA580C]">
            Sổ địa zchl của tôi →
          </button>
        </div>
      </div>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <button className="text-sm text-[#F97316] hover:text-[#EA580C] mt-1">
                  Sổ địa chỉ của tôi
                </button>
              </div>
            </div>
